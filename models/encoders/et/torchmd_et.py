...
from models.encoders.et.utils import (
    NeighborEmbedding,
    CosineCutoff,
    rbf_class_mapping,
    act_class_mapping,
...
class ETEncoder(BaseModel):
    r"""The TorchMD Equivariant Transformer (ET) architecture.
    ...
    Args:
        ...
        max_z (int, optional): Maximum atomic number. Used for initializing embeddings.
            (default: :obj:`100`)
        max_neighbors (int, optional): Maximum number of neighbors to return for a
    ...
    def __init__(
        ...
        self.distance_expansion = rbf_class_mapping[rbf_type](
            0.0, cutoff, num_rbf, trainable_rbf
        )
        self.neighbor_embedding = (
            NeighborEmbedding(
                hidden_channels, num_rbf, 0.0, cutoff, self.max_z, dtype
            ).jittable()
