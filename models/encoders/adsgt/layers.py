...
class AtomPosEncoder(nn.Module):
    def __init__(
        self,
        hidden_dim: int = 128,
        ...
        super(AtomPosEncoder, self).__init__()

        self.atom_pos_expansion = GaussianSmearing(
            start=0.0,
            stop=1.0,
    ...
    def forward(self, data):
        ...
        atom_h = atom_height(data)
        node_pos_emb = self.atom_pos_expansion(atom_h)
...
class AdsGTAttn(MessagePassing):
    _alpha: OptTensor
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(AdsGTAttn, self).__init__(node_dim=0, **kwargs)
