...
class Flags:
    ...
    def add_core_args(self) -> None:
        ...
        self.parser.add_argument(
            "--mode",
            choices=["train", "pretrain", "predict", "attn4sites", "uncertainty", "ensemble"],
            required=True,
            help="Whether to train/pretrain models, predict, or run attn4sites",
        )
        self.parser.add_argument(
            "--runs", default=1, type=int,
            help="Repeat training times under different random seeds"
        )
        self.parser.add_argument(
            "--config-yml",
            required=True,
        ...
        self.parser.add_argument(
            ...
            default="./",
            type=str,
            help="Directory to store checkpoints of model ensemble",
        )
        self.parser.add_argument(
            "--print-every",
            default=10,
